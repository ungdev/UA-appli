  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <p>
            Utilisez le bouton "copier" dans l'éditeur de deck d'Hearthstone, et collez directement
            le résultat dans le champ ci dessous :
          </p>
        ...
        {thisUser && (
          ...
          >
            <HsDecksCards decks={thisUser.decks} golden={this.state.golden} canDelete />
          </Card>
        )}
      </div>
    );
