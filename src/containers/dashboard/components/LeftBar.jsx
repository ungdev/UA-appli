...
class LeftBar extends React.Component {
  ...
  loadTournaments = () => {
      const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjI0MzhhODdmLWEyZDctNGI2Yy1hNmI1LTM0ZWQ5MjY2NTEzOSIsImlhdCI6MTUzNzMwNDI5MCwiZXhwIjoxNTM3MzExNDkwfQ.aLGGuzLNbWhfvHXKgsQfXaaRK6l5NywjYfvvaUY4vDA'
      axios.get('spotlights', { headers: { 'X-Token': authToken } })
      .then((res) => {
        console.log(res)
        this.setState({loaded: true, spotlights: res.data})
      })
      .catch ((err) => {
        console.log(err)
      })
  ...
  render() {
    let content = this.state.loaded ? <div>
