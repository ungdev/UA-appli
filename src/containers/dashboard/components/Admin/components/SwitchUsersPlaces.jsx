    ...
    return (
      <React.Fragment>
        {this.state.users && this.state.users[0] && this.state.users[1] && (
          <Button type="primary" onClick={this.openModal} style={{ margin: '0 0 20px 10px' }}>
            <Icon type="swap" />
            Échanger les places
          </Button>
        )}
        ...
        <div className="switch-users-places-container">
          <Card title="Utilisateur 1">
            {this.state.users[0] ? (
              <React.Fragment>
                <p>
                  Utilisateur : <strong>{this.state.users[0].fullname}</strong>
                </p>
                <p>
                  Place : <strong>{this.state.users[0].place || '(Aucune)'}</strong>
                </p>
          ...
          <Card title="Utilisateur 2">
            {this.state.users[1] ? (
              <React.Fragment>
                <p>
                  Utilisateur : <strong>{this.state.users[1].fullname}</strong>
                </p>
                <p>
                  Place : <strong>{this.state.users[1].place || '(Aucune)'}</strong>
                </p>
        ...
        <Modal
          ...
          okText={
            <React.Fragment>
              <Icon type="swap" /> Échanger
            </React.Fragment>
          }
          cancelText="Annuler"
        >
          <p>
            <strong>Vous allez échanger les places de deux joueurs.</strong>
          </p>
        </Modal>
      </React.Fragment>
    )
