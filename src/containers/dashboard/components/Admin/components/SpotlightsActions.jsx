      ...
      <React.Fragment>
                      ...
                      <div>
                        {user.isCaptain ? (
                          <Tooltip title="Chef d'équipe">
                            <Icon type="star" style={{ color: '#1890ff', marginRight: '5px' }} />
                          </Tooltip>
                        ) : (
                          ''
                        )}{' '}
                  ...
                  {!user.isCaptain ? (
                    <Tooltip placement="left" title="Rendre chef d'équipe">
                      <Button
                        type="primary"
                        onClick={() => {
                          this.setState({ captainId: user.id })
                          return this.openSetCaptainModal()
                        }}
        ...
        >
          ...
          <p>
            <i>Ancien:</i>
            <br />
            <strong>Équipe : {team.name}</strong>
          </p>
          <p>
            <i>Nouveau:</i>
            <br />
            <strong>Équipe : {this.state.teamName}</strong>
          </p>
        </Modal>
